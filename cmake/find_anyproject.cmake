...
function(find_anyproject name)
    ...
    if(NOT WITH_${name}_EXTERNAL AND ${IS_FOUND})
        ...
        if(${UPPER_NAME}_LIBRARIES)
            set(IMPORTED_TARGET_LINK_LIB ${IMPORTED_TARGET_LINK_LIB} ${${UPPER_NAME}_LIBRARIES} PARENT_SCOPE)
        elseif(${UPPER_NAME}_LIBRARY)
            set(IMPORTED_TARGET_LINK_LIB ${IMPORTED_TARGET_LINK_LIB} ${${UPPER_NAME}_LIBRARY} PARENT_SCOPE)
        endif()   
    else()
        set(IMPORTED_TARGET_LINK_LIB ${IMPORTED_TARGET_LINK_LIB} PARENT_SCOPE)   
...
function(target_link_extlibraries name)
    ...
    if(IMPORTED_TARGET_LINK_LIB)
        list(REMOVE_DUPLICATES IMPORTED_TARGET_LINK_LIB)
        target_link_libraries(${name} INTERFACE ${IMPORTED_TARGET_LINK_LIB})
    endif()
