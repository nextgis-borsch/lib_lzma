...
function(find_extproject name)
    ...
    foreach(_variableName ${_matchedVars})
        ...
        set(WITHARGS ${WITHARGS} "${_variableName}=${${_variableName}}")
    endforeach()
    ...
    if(NOT DEFINED WITHARGS_TMP)
        set(HAS_CHANGES TRUE)
    elseif((WITHARGS EQUAL WITHARGS_TMP) OR (WITHARGS STREQUAL WITHARGS_TMP))
    else()    
        set(HAS_CHANGES TRUE)
    endif()
    ...
    set(WITHARGS_TMP ${WITHARGS} CACHE INTERNAL "external options" FORCE)
